export const experiences = [
  ...
  },
  {
    ...
    // location: 'London',
    highlights: [
      'Kickstarted the development of a <a href="https://github.com/BeNeuroLab/beneuro_experimental_data_organization/tree/4539cad833147319af76da1e9f5c5bc903479aef" target="_blank" rel="noopener noreferrer">data processing pipeline and CLI tool</a> for handling experimental data recorded in the Be.Neuro Lab.',
    ],
  },
  {
...
export const education = [
  {
    ...
    location: 'London',
    project:
      'Project: Neural correlates of movement planning under uncertainty',
  ...
  },
  {
    ...
    description:
      'Multidisciplinary engineering program spanning life sciences, mathematics, and programming.',
  },
];
...
export const skills = [
  ...
  },
  {
    title: 'Languages',
    description:
      'English (fluent, C2), German (fluent, C1), Hungarian (native).',
  },
];
